...
class CrimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create crime' do
    assert_difference('Crime.count') do
      post crimes_url,
           params: { crime: { accused: @crime.accused, accuser: @crime.accuser, category_id: @crime.category_id,
                              date: @crime.date, statements: @crime.statements, unknown_others: @crime.unknown_others,
