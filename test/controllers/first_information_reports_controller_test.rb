...
class FirstInformationReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create first_information_report" do
    assert_difference('FirstInformationReport.count') do
      post first_information_reports_url, params: { first_information_report: { complainant_id: @first_information_report.complainant_id, date: @first_information_report.date, location: @first_information_report.location, offense: @first_information_report.offense, suspect_details: @first_information_report.suspect_details, user_id: @first_information_report.user_id } }
    end
  ...
  test "should update first_information_report" do
    patch first_information_report_url(@first_information_report), params: { first_information_report: { complainant_id: @first_information_report.complainant_id, date: @first_information_report.date, location: @first_information_report.location, offense: @first_information_report.offense, suspect_details: @first_information_report.suspect_details, user_id: @first_information_report.user_id } }
