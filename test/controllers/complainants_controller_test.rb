...
class ComplainantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create complainant' do
    assert_difference('Complainant.count') do
      post complainants_url,
           params: { complainant: { address: @complainant.address, criminal: @complainant.criminal,
                                    dob: @complainant.dob, firstname: @complainant.firstname,
                                    gender: @complainant.gender, nationality: @complainant.nationality,
                                    occupation: @complainant.occupation, phone: @complainant.phone,
                                    surname: @complainant.surname, user_id: @complainant.user_id } }
    end
  ...
  test 'should update complainant' do
    patch complainant_url(@complainant),
          params: { complainant: { address: @complainant.address, criminal: @complainant.criminal,
                                   dob: @complainant.dob, firstname: @complainant.firstname, gender:
                                     @complainant.gender, nationality: @complainant.nationality,
                                   occupation: @complainant.occupation, phone: @complainant.phone,
                                   surname: @complainant.surname, user_id: @complainant.user_id } }
